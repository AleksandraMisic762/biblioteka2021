...
class AutorTest {
	...
	@Test
	void testSetImePrekratakString() {
		assertThrows(java.lang.RuntimeException.class, () -> a.setIme("P"));
	}

	@Test
	void testSetImePrazanString() {
		assertThrows(java.lang.RuntimeException.class, () -> a.setIme(""));
	}
	...
	@Test
	void testSetPrezimePrekratakString() {
		assertThrows(java.lang.RuntimeException.class, () -> a.setPrezime("T"));
	}

	@Test
	void testSetPrezimePrazanString() {
		assertThrows(java.lang.RuntimeException.class, () -> a.setPrezime(""));
	}
	...
	void testEqualsObject(String ime1, String prezime1, String ime2, String prezime2, boolean equals) {
		a.setIme(ime1);
